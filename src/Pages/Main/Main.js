		...
		<div >
			...
			<div className="container">
				...
				<div className="main-title-text">
					<p>
					Ми є одним з найкращих підприємств України з обробки лазером акрилу та пропонуємо свої послуги всім, кому потрібно якісно обробити акрил (оргскло). Ми існуємо на ринку з 1996 року 
і також спеціалізуємося на продажу, різанні та виробах з оргскла, акрилу. Реалізуємо текстоліт, капролон та пароніт.

					</p>
					<p>
					У нас можна купити продукцію високої якості, використовуючи яку Ви здійсните виготовлення надійних конструкцій рекламного та іншого призначення.
Наші матеріали підходять для реклами та технічних контсрукцій, а листові пластики характеризуються міцністю та стійкістю. Це чудові матеріали для реклами із тривалим експлуатаційним терміном.
					</p>
				</div>
				</div>
